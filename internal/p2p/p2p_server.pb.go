...
const file_p2p_server_proto_rawDesc = "" +
	...
	"\asigData\x18\x02 \x03(\fR\asigData\"Y\n" +
	...
	"\x17RT_DEPOSIT_DISTRIBUTION\x10\x052\xca\x01\n" +
	"\x03P2P\x127\n" +
	...
	"\x15GetSigningSessionInfo\x12\x1e.p2p.SigningSessionInfoRequest\x1a\x17.p2p.SigningSessionInfo\"\x00B+Z)github.com/hyle-team/tss-svc/internal/p2pb\x06proto3"
