...
var (
	...
	Instruction_DepositNativeAndSwap  = ag_binary.TypeID([8]byte{198, 188, 75, 242, 180, 37, 33, 123})
	Instruction_DepositSpl            = ag_binary.TypeID([8]byte{224, 0, 198, 175, 198, 47, 105, 204})
	Instruction_DepositSplAndSwap     = ag_binary.TypeID([8]byte{203, 205, 59, 4, 1, 237, 9, 172})
	Instruction_DepositWrapped        = ag_binary.TypeID([8]byte{55, 72, 116, 0, 195, 33, 142, 235})
	Instruction_DepositWrappedAndSwap = ag_binary.TypeID([8]byte{117, 127, 241, 77, 160, 147, 20, 139})
...
func InstructionIDToName(id ag_binary.TypeID) string {
	...
	case Instruction_DepositNativeAndSwap:
		return "DepositNativeAndSwap"
	case Instruction_DepositSpl:
		return "DepositSpl"
	case Instruction_DepositSplAndSwap:
		return "DepositSplAndSwap"
	case Instruction_DepositWrapped:
		return "DepositWrapped"
	case Instruction_DepositWrappedAndSwap:
		return "DepositWrappedAndSwap"
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		...
		{
			Name: "deposit_native_and_swap", Type: (*DepositNativeAndSwap)(nil),
		},
		{
			Name: "deposit_spl", Type: (*DepositSpl)(nil),
		},
		{
			Name: "deposit_spl_and_swap", Type: (*DepositSplAndSwap)(nil),
		},
		{
			Name: "deposit_wrapped", Type: (*DepositWrapped)(nil),
		},
		{
			Name: "deposit_wrapped_and_swap", Type: (*DepositWrappedAndSwap)(nil),
		},
		{
