...
var eventTypes = map[[8]byte]reflect.Type{DepositEventEventDataDiscriminator: reflect.TypeOf(DepositEventEventData{})}
var eventNames = map[[8]byte]string{DepositEventEventDataDiscriminator: "DepositEvent"}
var (
	_ fmt.Formatter = nil
)
var (
