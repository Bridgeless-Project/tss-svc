...
var _ DepositSigningData = EvmMerkelizedWithdrawalData{}
var _ Constructor[EvmMerkelizedWithdrawalData] = &EvmMerkelizedWithdrawalConstructor{}

type EvmMerkelizedWithdrawalData struct {
	ProposalData     *p2p.EvmMerkelizedProposalData
	SignedWithdrawal string
}

func (e EvmMerkelizedWithdrawalData) DepositIdentifiers() []db.DepositIdentifier {
...
func (e EvmMerkelizedWithdrawalData) HashString() string {
	if e.ProposalData == nil {
		return ""
	}
...
type EvmMerkelizedWithdrawalConstructor struct {
	client *evm.Client
}

func (c *EvmMerkelizedWithdrawalConstructor) FormSigningData(deposits ...db.Deposit) (*EvmMerkelizedWithdrawalData, error) {
	...
	return &EvmMerkelizedWithdrawalData{
		ProposalData: &p2p.EvmMerkelizedProposalData{
...
func (c *EvmMerkelizedWithdrawalConstructor) IsValid(data EvmMerkelizedWithdrawalData, deposits ...db.Deposit) (bool, error) {
